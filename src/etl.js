...
const TABLES = {
  ...
  // New tables
  visits: { parser: VisitParser, supaTable: 'visits' },
  accounts: { parser: AccountParser, supaTable: 'accounts' },
  appointments: { parser: AppointmentParser, supaTable: 'appointments' },
  medical: { parser: MedicalParser, supaTable: 'medical' },
  prescriptions: { parser: PrescriptionParser, supaTable: 'prescriptions' },
  vaccines: { parser: VaccineParser, supaTable: 'vaccines' },
  followups: { parser: FollowUpParser, supaTable: 'followups' },
  diagnoses: { parser: DiagnoseParser, supaTable: 'diagnoses' },
  problems: { parser: ProblemParser, supaTable: 'problems' },
  vendors: { parser: VendorParser, supaTable: 'vendors' },
  procedures: { parser: ProcedureParser, supaTable: 'procedures' },
  usage: { parser: UsageParser, supaTable: 'usage_records' },
  quotes: { parser: QuoteParser, supaTable: 'quotes' },
  quote_details: { parser: QuoteDetailParser, supaTable: 'quote_details' },
  variances: { parser: VarianceParser, supaTable: 'variances' },
  whiteboard: { parser: WhiteboardParser, supaTable: 'whiteboard' },
  probhist: { parser: ProbHistParser, supaTable: 'prob_history' },
  resources: { parser: ResourceParser, supaTable: 'resources' },
